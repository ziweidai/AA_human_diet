%---------- Analyze landscape of amino acids in human foods -------------%
% Input datasets:
%   1.FoodMatrix.csv: Structured table with abundances of 178 nutrients in
%   8788 human foods
%   2.MinServing.txt: weight of one serving of each food
%   3.Bounds.txt: Ranges of recommended intake of each nutrient in USDA
%   2015-2020 dietary guidelines for Americans
%
% Output:../data/AA_variables.mat
%------------------------------------------------------------------------%
...
load input_data/MinServing.txt % Serving size in grams for each food
clear x
...
load input_data/Bounds.txt % Bounds defined by USDA nutritional goals
